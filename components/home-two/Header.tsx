...
const Header = () => {
  ...
  return (
    <header className={`header header-two ${scrolled ? "scrolled" : ""}`}>
      <div className="header-container">
        ...
        <div className="d-flex menu-dropdown-container">
          ...
          <Link href="/compare-brokers" className="btn fw-semibold cursor-pointer d-none d-lg-flex btn-secondary align-items-center gap-2">
